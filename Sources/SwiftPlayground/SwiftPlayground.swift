...
struct SwiftPlayground {
    static func main() {
        ...
        /// Updates the stocks and records the sales if the customer comfirms.
        /// 
        /// - Parameters:
        ...
        /// Prompts the owner to add kumara stock, validating that the amount is 
        /// within acceptable bounds, and not exceed the maximum stock capacity.
        func addStock() {
            ...
            // Check stock amount is positive and not exceeding maximum stock amount.
            if stock <= 0 || stock > maxStock{
                print("Invalid stock, Maximum stock amount should be 1 - 50.")
                return addStock()
            }

            // Check adding the new stock doesn't exceed the maximum capacity.
        ...
        /// Display remaining stocks.
        func viewStocks() {
            print("Remaining stocks: \(kumaraStock)")
        }

        /// Displays all previously completed sales records, showing the weight and bags per transaction.
        func salesRecords() {

            // If sales records are empty, displays a message.
            if sales.isEmpty {
                print("No records.")
            } else {
                print("Sales records: ")
        ...
        /// Calculates and displayes a summery for all sales, including:
        ...
        func calculateSummery() {
            ...
            // Gather totals across the records.
            for sale in sales {
                totalWeight += sale.0
                totalBags += sale.1
        ...
        /// Displayes the owner menu, allowing the owner to manage stocks, 
        /// view records, previous sales and access summeries.
        func ownerMenu() {
            repeat {
                print("""
                == Ownner menu ==
                ...
                // Ensure the input is a valid option.
        ...
        /// Allows customer to specify the number of bags.
        func getBags(weight: Double)-> Int {
            print(" Enter bag used: ")

            // Validate the bag count input is a valid interger.
        ...
        /// Guides the customer through purchase process, collecting their kumara weight
        /// and number of bags, validating both inputs before proceeding to the sale.
        func customerMenu() {
            print("""
